    ...
    public function updatePassword(): void
    {
        try {
            $validated = $this->validate([
                ...
                'password' => ['required', 'min:8', 'string', Password::defaults(), 'confirmed'],
            ],
            [
                ...
                'password.confirmed' => 'La confirmation est incorrect.', 
            ]);
...
<section>
    <header>
        ...
        <p class="mt-1 text-sm text-gray-600">
            {{ __('Veuillez utiliser un mot de passe suffisamment long et aléatoire pour garder votre compte sécurisé.') }}
        </p>
    </header>
    ...
    <form wire:submit="updatePassword" class="mt-6 space-y-6">
        ...
        <div>
            <x-input-label for="update_password_password_confirmation" :value="__('Confirmez le nouveau mot de passe')" />
