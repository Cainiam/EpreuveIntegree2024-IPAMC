<!-- Adapted from navigation blade php for guest navigation -->
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <!-- Guest part of the nav bar --> 
                    <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex bg-green-50">
                        <x-nav-link :href="route('login')" :active="request()->routeIs('login')" wire:navigate>
                            {{ __('Se connecter') }}
                        </x-nav-link>
                    </div>

                    <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex bg-blue-50">
