<div class="container mx-auto py-8">
    <h2 class="text-2xl font-bold mb-4 bg-blue-100 border border-gray-300 rounded-lg p-4 pl-6 shadow">Ajout de société</h2>
    ...
    <form wire:submit.prevent="addShippingcompany" class="bg-blue-50 border border-gray-300 rounded-lg px-2 py-2">
        <div class="mb-4">
        ...
        <div class="px-2 py-2">
            <button type="submit" class="bg-green-500 hover:bg-green-600 text-white px-2 py-2 rounded-lg">Ajouter la société</button>
