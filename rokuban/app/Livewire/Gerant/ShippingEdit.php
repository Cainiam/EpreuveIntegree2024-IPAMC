...
{
    public $shippingId, $shippingcompany_id, $name, $description, $price, $isVisible, $shippingcompanies;
    ...
    protected function rules()
    {
        return [
            ...
            'name' => ['required', 'string', 'min:2', 'max:255', Rule::unique('shippings')->ignore($this->shippingId)],
    ...
    public function updateShipping()
    {
        ...
        $shipping = Shipping::findOrFail($this->shippingId);
        ...
        session()->flash('message', 'Moyen de livraison mis à jour avec succès.');
        return redirect()->route('gerantdashboard');
    }

    public function render()
    {
        return view('livewire.gerant.shipping-edit')->layout('layouts.app');
    }
}
